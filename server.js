...
//-------------Getting User Name this will be displayed on second page (later on):
...
//-------------User name from sign up stage and displayed on second page:
...
//-------------User can delete previous chat logs:
...
//-------------fetching Route number of bus/train/tram and displaying on second page:
...
//-------------disconnects user from multiple rooms and keeps the user in current chat room only:
